...
<input type="hidden" id="dispatcher" value="register">
<div class="pop-box h-auto bg-ff">
    ...
    <div class="text-c mar-b20"><a href="javascript:;" data-action="js/mock-data/include-data-example.json" data-href="挂号.shtml" id="Charge" class="green-but">确定</a>&nbsp;<a href="javascript:;" class="black-but" id="cancel">取消</a></div>
    </form>
</div>
